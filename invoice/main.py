...
from database import searchinvoice,checksignup,checksignin,checkforgotpass,changepassword
...
templates = Jinja2Templates(directory="C:\\Users\\hp\\Desktop\\python\\invoice\\templates")
