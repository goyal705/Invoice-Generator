...
import inflect
import qrcode
from database import generate_random_code,insert_data
import os
...
def create_invoice_img(data):
    ...
    invoice_no=generate_random_code(5) #generating invoice code   
    ...
    img = Image.open('C:\\Users\\hp\\Desktop\\python\\invoice\\images\\invoice_template.jpg')
    ...
    #adding signature
    sign = Image.open("C:\\Users\\hp\\Desktop\\python\\invoice\\images\\signature_image.png")
    ...
    imgpath=f'C:\\Users\\hp\\Desktop\\python\\invoice\\Output_images\\{invoice_no}.jpg'    
